...
- Codex 주간 한도와 Claude 5시간 한도의 남은 비율을 각각의 공식 로고와 함께 메뉴 막대에 표시
- 메뉴 막대 항목 우클릭으로 Codex·Claude의 한도·초기화 시간·토큰·원화 환산을 함께 확인
...
- Dock에는 나타나지 않고 메뉴 막대에 Codex·Claude 사용량 항목을 각각 유지합니다.
